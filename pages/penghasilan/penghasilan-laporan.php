...
<body class="A4">
  ...
  <section class="sheet padding-10mm " style="height: auto;font-size: 10px;overflow: auto; ">
    ...
    <h1 style="margin-top: 15px; text-decoration: underline;" class="text-center">SURAT KETERANGAN PENGHASILAN</h1>
    <h3 style="margin-top: 3px;" class="text-left"> Nomor : ......./................/............/......./............</h3>
        <?php
          ...
          <table class="" style="font-size:12px;" cellpadding="0" cellspacing="0">
              <td colspan="3" style="text-align:justify;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Lurah Mangsang Kecamatan Sungai Beduk Kota Batam dengan ini, menerangkan bahwa:</td>
            </tr>
            <tr>
            ...
            <tr>
              <td style="text-align:left;width: 160px;">Tempat/Tanggal Lahir</td>
              <td style="width:10px;">:</td>
            ...
            <tr>
              ...
              <td style="width:10px;">:</td>
              <td style="text-align:left;" class="uppercase-text"><?= $data_penduduk['pekerjaan'] ?></td>
            </tr>
            <tr>
            ...
            <tr>
              <td style="text-align:left;width: 160px;">Pemegang KTP/KK NO</td>
              <td style="width:10px;">:</td>
              <td style="text-align:left;"><?= $row['nik'] ?></td>
            </tr>

            <tr>
              <td colspan="3" style="text-align:justify;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Berdasarkan surat pengantar RT/RW. Nomor : ......./.............../......../............/.............../......../....... tanggal ......./....../.........., Adalah benar berstatus sebagai warga kami yang bekerja/berprofesi sebagai <strong class="uppercase-text"><?= $data_penduduk['pekerjaan'] ?></strong> dan berpenghasilan rata-rata per bulan sebesar : <strong><?= 'RP ' . number_format($row['gaji'], 0, ',', '.'); ?></strong>, dengan jumlah <strong>tanggungan keluarga/Anak Sejumlah <?= $row['tanggungan'] ?> orang.</strong></td>
            </tr>
            <tr>
              <td colspan="3" style="text-align:justify;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Demikian surat keterangan ini dibuat dengan sebenar-benarnya dan data yang diisikan sesuai kondisi yang sesungguhnya untuk keperluan/syarat <strong class="uppercase-text">" <?= $row['keperluan'] ?> di <?= $row['pendidikan'] ?> ".</strong></td>
            </tr>
            <tr>
              <td style="text-align:left;width: 160px;">Kepada :</td>
            </tr>
            <tr>
              <td style="text-align:left;width: 160px;">Nama</td>
              <td style="width:10px;">:</td>
              <td style="text-align:left;" class="uppercase-text"><strong><?= $row['nama_anak'] ?></strong></td>
            </tr>
            <tr>
              <td style="text-align:left;width: 160px;">Tempat/tgl. Lahir</td>
              <td style="width:10px;">:</td>
              <td style="text-align:left;" class="uppercase-text"><?= $row['tempat_lahir_anak'] ?>, <?= date('d - m - Y', strtotime($row['tanggal_lahir_anak'])); ?>
            </tr>
            <tr>
              <td style="text-align:left;width: 160px;">Jurusan</td> </td>
              <td style="width:10px;">:</td>
              <td style="text-align:left;" class="uppercase-text"><?= $row['jurusan_anak'] ?></td>
            </tr>
            <tr>
              <td style="text-align:left;width: 160px;">Hubungan Keluarga </td>
              <td style="width:10px;">:</td>
              <td style="text-align:left;" class="uppercase-text"><?= $row['hubungan_keluarga'] ?></td>
            </tr>
            <tr>
              <td colspan="3" style="text-align:justify;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Demikianlah Surat Keterangan ini dibuat dan apabila di kemudian hari ditemukan perbedaan data, maka saya sanggup bertanggung jawab.</td>
            </tr>
          </table>
